    ...
    'print_area': {
        ...
        'options': {
            'outside': {
                ...
                'image': 'img/product_detail/cardboard/expansion/ntype-custominsert/outside.jpg',
                'options': {
            ...
            #     'default': '',
            #     'widget_type': 'modal-check',
            #     'image': 'img/product_detail/cardboard/expansion/ntype-custominsert/inside.jpg',
            #     'options': {
            #         'A': {'name': 'A', 'value': 'A', 'extra': ''},
            #         'B': {'name': 'B', 'value': 'B', 'extra': ''},
            #         'C': {'name': 'C', 'value': 'C', 'extra': ''},
        ...
        'options': {
            '1': {
                ...
                'extra': 'ダンボールそのままの素材です。\n' \
                         ...
                         '印刷に使える色に制限があります。',
                'image': 'img/product_detail/cardboard/surface_material/ntype-custominsert/material_1.jpg'
            },
            '2': {
                'name': '白ダンボール',
                'value': 'white',
                'extra': 'コストを抑えて上質感を出せる素材です。\n' \
                         '印刷に使える色に制限があります。',
                'image': 'img/product_detail/cardboard/surface_material/ntype-custominsert/material_2.jpg'
            },
            '3': {
                'name': '合紙素材',
                'value': 'laminating',
                ...
                'image': 'img/product_detail/cardboard/surface_material/ntype-custominsert/material_3.jpg'
            },
        },
        'note': {
            "title": "ダンボールの生地について",
