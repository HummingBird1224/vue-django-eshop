...
data = {
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'image': 'img/external/colorme/size/tape-opp-bag/a6.jpg',
                'data': ''
            },
            '2': {
                'name': ' A5サイズ',
                ...
                'image': 'img/external/colorme/size/tape-opp-bag/a5.jpg',
                'data': ''
            },
            '3': {
                'name': 'A4サイズ',
                ...
                'image': 'img/external/colorme/size/tape-opp-bag/a4.jpg',
                'data': ''
            },
        }
    },
    ...
    'choosable_color': [
        ...
        {'name': '2色(PANTONEから選択)',
         ...
         'image': 'img/external/colorme/color/pantone.png'},
    ],
}
