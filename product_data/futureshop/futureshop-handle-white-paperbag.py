...
data = {
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'image': 'img/external/futureshop/size/handle-white-paperbag/a5_deep.jpg',
                'data': ''
            },
            '2': {
                'name': 'B5マチ広',
                ...
                'image': 'img/external/futureshop/size/handle-white-paperbag/b5_deep.jpg',
                'data': ''
            },
            '3': {
                'name': 'A5正方形',
                ...
                'image': 'img/external/futureshop/size/handle-white-paperbag/a5_square.jpg',
                'data': ''
            },
            '4': {
                'name': 'A4マチ広',
                ...
                'image': 'img/external/futureshop/size/handle-white-paperbag/a4_deep.jpg',
                'data': ''
            },
            '5': {
                'name': 'A4幅大',
                ...
                'image': 'img/external/futureshop/size/handle-white-paperbag/a4_wide.jpg',
                'data': ''
            },
            '6': {
                'name': 'A4幅大マチ広',
                ...
                'image': 'img/external/futureshop/size/handle-white-paperbag/a4_wide_deep.jpg',
                'data': ''
            },
        },
    },
    ...
    'choosable_color': [
        ...
        {'name': '金', 'image': 'img/external/futureshop/color/gold.png'},
        {'name': '銀', 'image': 'img/external/futureshop/color/silver.png'},
    ],
}
