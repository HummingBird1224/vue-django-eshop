...
data = {
    ...
    'example': {
        ...
        'color_num': '2色印刷',
        'size': '160mm × 140mm',
        'image': 'img/product_detail/common/example/zip_aluminum_bag_example.jpg',
        'extras': [
            '素材　アルミ蒸着',
            '加工　ノッチ / 角丸'
        ]
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'image': 'img/external/futureshop/size/zip-aluminum-bag/50g.jpg',
                'data': ''
            },
            '2': {
                'name': '粉末150g用',
                ...
                'image': 'img/external/futureshop/size/zip-aluminum-bag/150g.jpg',
                'data': ''
            },
            '3': {
                'name': '粉末200g用',
                ...
                'image': 'img/external/futureshop/size/zip-aluminum-bag/200g.jpg',
                'data': ''
            }
        }
    },
    ...
    'choosable_color': [
        {'name': 'フルカラー', 'image': 'img/external/futureshop/color/fullcolor.png'},
    ],
}
