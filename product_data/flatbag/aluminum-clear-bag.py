    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'data': 'design_templates/flatbag/aluminum_clear_bag/aluminum_clear_bag_t_shirt.ai'
            },
            '2': {
                'name': '長袖インナー用サイズ',
                'value': [
                ...
                'data': 'design_templates/flatbag/aluminum_clear_bag/aluminum_clear_bag_long_sleeve.ai'
            }
        }
    },
    'color_num': {
