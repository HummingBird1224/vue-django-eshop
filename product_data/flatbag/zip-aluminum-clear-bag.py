    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'data': 'design_templates/flatbag/zip_aluminum_clear_bag/zip_aluminum_clear_bag_shirt.ai'
            },
            '2': {
                'name': '長袖インナー用サイズ',
                'value': [
                ...
                'data': 'design_templates/flatbag/zip_aluminum_clear_bag/zip_aluminum_clear_bag_long_sleeve.ai'
            }
        }
    },
    'color_num': {
