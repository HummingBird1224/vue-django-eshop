...
data = {
    ...
    'notes': {
        ...
        'value': '',
        'extra': [
            {'key': 'シール幅', 'value': '5 ~ 10mm'},
            {'key': 'チャック上', 'value': '30mm'},
            {'key': '基材構成', 'value': 'PET12//AL7//LLDPE60'},
            {'key': '', 'value': '幅と奥行きは型が必要になるためセットで決める必要があります。'},
        ],
        'image': '',
    },
    'choosable_color': {
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'extra': '高さ310mm 幅250mm 奥行き100mm',
                'image': 'img/product_detail/film/size/zip-aluminum-stand/zip-aluminum-stand_protein.jpg',
                'data': 'design_templates/flatbag/zip_aluminum_stand/zip_aluminum_stand_protein.ai'
            },
            '2': {
                'name': 'コーヒー 200g用',
                'value': [
                ...
                'extra': '高さ220mm 幅160mm 奥行き74mm',
                'image': 'img/product_detail/film/size/zip-aluminum-stand/zip-aluminum-stand_coffee.jpg',
                'data': 'design_templates/flatbag/zip_aluminum_stand/zip_aluminum_stand_coffee.ai'
            },
            '3': {
                'name': 'お茶100g用',
                'value': [
                ...
                'extra': '高さ200mm 幅120mm 奥行き70mm',
                'image': 'img/product_detail/film/size/zip-aluminum-stand/zip-aluminum-stand_tea.jpg',
                'data': 'design_templates/flatbag/zip_aluminum_stand/zip_aluminum_stand_tea.ai'
            }
        }
    },
    'color_num': {
    ...
    'material': {
        ...
        'options': {
            '1': {
                'name': '通常',
                'value': 'normal',
                'extra': '光沢のあるアルミ素材。ガシガシした手触りに。',
                'image': 'img/product_detail/film/material/normal.jpg'
            },
            '2': {
                'name': 'マットPET',
                'value': 'mattepet',
                'extra': 'コシがあるがさらさらした手触りが特徴で、やや光沢があります。',
                'image': 'img/product_detail/film/material/mattepet.jpg'
            },
            '3': {
                'name': 'ハイマット',
                'value': 'highmatte',
                'extra': 'しっとりとした手触りで、光沢がほぼないのが特徴です。落ち着いた高級感を出します。',
                'image': 'img/product_detail/film/material/highmatte.jpg'
            },
        },
        'note': {
            'title': '材質について',
            'sections': [
                {
                    ...
                    'contents': [
                        ...
                        },
                        {
                            ...
                            'image': 'img/product_detail/film/material/highmatte.jpg',
                            'body': [
                                'しっとりとした手触りで、光沢がほぼないのが特徴です。落ち着いた高級感を出します。',
                            ]
                        },
                    ]
                },
