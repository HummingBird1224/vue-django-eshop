...
data = {
    ...
    'notes': {
        ...
        'value': '',
        'extra': [
            {'key': '基材構成', 'value': 'PET#12 VMPET#12 LLDPE#60~100 （※サイズによって変動）'},
        ],
        'image': '',
    },
    'choosable_color': {
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'data': 'design_templates/flatbag/zip_aluminum_bag/zip_aluminum_bag_t_shirt.ai'
            },
            '2': {
                'name': '長袖インナー用サイズ',
                'value': [
                ...
                'data': 'design_templates/flatbag/zip_aluminum_bag/zip_aluminum_bag_long_sleeve.ai'
            }
        }
    },
    'color_num': {
