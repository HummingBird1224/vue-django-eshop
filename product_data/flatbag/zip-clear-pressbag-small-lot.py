    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'data': 'design_templates/flatbag/zip_clear_pressbag_small_lot/zip_clear_pressbag_t_shirt.ai'
            },
            '2': {
                'name': '長袖インナー用サイズ',
                'value': [
                ...
                'data': 'design_templates/flatbag/zip_clear_pressbag_small_lot/zip_clear_pressbag_long_sleeve.ai'
            }
        }
    },
    'color_num': {
