...
data = {
    ...
    'notes': {
        ...
        'value': '',
        'extra': [
            {'key': '基材構成', 'value': 'PET12/PE/AL7/PE/LLDPE30'},
        ],
        'image': '',
    },
    'choosable_color': {
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'extra': '高さ80mm 幅60mm',
                'data': 'design_templates/flatbag/subsection_bag/subsection_bag_supplement.ai'
            },
            '2':  {
                'name': '粉末状健康食品用',
                'value': [
                ...
                'extra': '高さ80mm 幅40mm',
                'data': 'design_templates/flatbag/subsection_bag/subsection_bag_powder.ai',
            },
        }
    },
    'color_num': {
