...
data = {
    ...
    'size': {
        ...
        'options': {
            '1': {
                ...
                'image': 'img/external/base/size/zip-aluminum-bag/50g.jpg',
                'data': ''
            },
            '2': {
                'name': '粉末150g用',
                ...
                'image': 'img/external/base/size/zip-aluminum-bag/150g.jpg',
                'data': ''
            },
            '3': {
                'name': '粉末200g用',
                ...
                'image': 'img/external/base/size/zip-aluminum-bag/200g.jpg',
                'data': ''
            }
        }
    },
    ...
    'choosable_color': [
        {'name': 'フルカラー', 'image': 'img/external/base/color/fullcolor.png'},
    ],
}
