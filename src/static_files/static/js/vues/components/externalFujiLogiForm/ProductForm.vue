<template>
  <div class="p-externalFujiLogiProducts-product-content-purchase">
    <div class="p-externalFujiLogiProducts-product-content-header">
      <svg>
    ...
    <div class="p-externalBaseProducts-product-content-purchase-form">
      ...
      <div class="p-externalFujiLogiProducts-product-content-purchase-footer">
        <PriceInfo
          :price="price"
        />
        <div class="p-externalFujiLogiProducts-product-content-purchase-footer-button">
