<template>
  <div class="p-externalFujiLogiProducts-product-content-info">
        ...
        <ul>
          <template v-if="hasColorSelect">
            <li
              ...
              class="p-externalFujiLogiProducts-product-content-info-color-item"
            >
              <div class="p-externalFujiLogiProducts-product-content-info-color-image">
          ...
          >
            <li>
            <div
              class="p-externalFujiLogiProducts-product-content-info-color p-externalFujiLogiProducts-product-content-info-color--black"></div>
            <p>黒</p>
          </li>
          <li>
            <div
              class="p-externalFujiLogiProducts-product-content-info-color p-externalFujiLogiProducts-product-content-info-color--white"></div>
            <p>白</p>
          </li>
          </template>
        </ul>
