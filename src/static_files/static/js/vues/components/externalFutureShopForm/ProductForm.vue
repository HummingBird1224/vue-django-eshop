<template>
  <div class="p-externalFutureShopProducts-product-content-purchase">
    <div class="p-externalFutureShopProducts-product-content-header">
      <svg>
    ...
    <div class="p-externalBaseProducts-product-content-purchase-form">
      ...
      <div class="p-externalFutureShopProducts-product-content-purchase-footer">
        <PriceInfo
          :price="price"
        />
        <div class="p-externalFutureShopProducts-product-content-purchase-footer-button">
