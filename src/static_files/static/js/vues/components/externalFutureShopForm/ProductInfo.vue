<template>
  <div class="p-externalFutureShopProducts-product-content-info">
        ...
        <ul>
          <template v-if="hasColorSelect">
            <li
              ...
              class="p-externalFutureShopProducts-product-content-info-color-item"
            >
              <div class="p-externalFutureShopProducts-product-content-info-color-image">
          ...
          >
            <li>
            <div
              class="p-externalFutureShopProducts-product-content-info-color p-externalFutureShopProducts-product-content-info-color--black"></div>
            <p>黒</p>
          </li>
          <li>
            <div
              class="p-externalFutureShopProducts-product-content-info-color p-externalFutureShopProducts-product-content-info-color--white"></div>
            <p>白</p>
          </li>
          </template>
        </ul>
...
export default {
  ...
  computed: {
    isNotPlain() {
      return this.product.slug !== 'FutureShop-atype-plain';
    },
    shippingInfo() {
