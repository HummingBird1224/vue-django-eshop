<template>
  <div class="p-externalBaseProducts-product-content-purchase">
    <div class="p-externalBaseProducts-product-content-header">
      <svg>
    ...
    <div class="p-externalBaseProducts-product-content-purchase-form">
      ...
      <ColorNameSelectField
        v-if="colorName && hasMultipleOptions(colorName, 'color_name')"
        :canChange="canChangeColor"
        :form="form"
        :colorName="colorName"
        @onClick="applyFormValue"
      ...
      <div class="p-externalBaseProducts-product-content-purchase-footer">
        <PriceInfo
          :price="price"
        />
        <div class="p-externalBaseProducts-product-content-purchase-footer-button">
...
import ColorNameSelectField from "./ColorNameSelectField";

export default {
  name: "ProductForm",
  mixins: [StoreMixin],
  components: {ColorSelectField, PriceInfo, QuantitySelectField, PrintAreaNumSelectField,
               DesignNumSelectField, SizeSelectField, MaterialSelectField, ColorNameSelectField},
  data: () => ({
    isProcessing: false,
    form: {
      size: null,
  ...
  computed: {
    ...
    canChangeMaterial() {
      ...
      if (this.colorName && this.form.color_name === null) {
        return false;
      }
      return true;
    },
    ...
    colorName() {
      return this.options.find(option => option.slug === 'color_name');
    },
    quantity() {
    ...
    postValue() {
      ...
      if (this.colorName) {
        postValue.color_name = this.form.color_name;
      }
  ...
  methods: {
    ...
    doesMeetCondition(field, fieldName) {
