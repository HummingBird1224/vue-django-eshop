<template>
  <div class="p-externalBaseProducts-product-content-info">
    ...
    <ul>
      ...
      <li>
        ...
        <p v-if="isNotBaseOriginal">無料</p>
        <p v-else>サイズと注文数により変動します</p>
      </li>
      <li v-if="isNotBaseOriginal">
        <svg>
        ...
        <ul>
          <template v-if="hasColorSelect">
            <li
              ...
              class="p-externalBaseProducts-product-content-info-color-item"
            >
              <div class="p-externalBaseProducts-product-content-info-color-image">
          ...
          >
            <li>
            <div
              class="p-externalBaseProducts-product-content-info-color p-externalBaseProducts-product-content-info-color--black"></div>
            <p>黒</p>
          </li>
          <li>
            <div
              class="p-externalBaseProducts-product-content-info-color p-externalBaseProducts-product-content-info-color--white"></div>
            <p>白</p>
          </li>
          </template>
        </ul>
      ...
      <li v-if="isNotBaseOriginal && isNotPlain">
        <svg>
...
export default {
  ...
  computed: {
    ...
    isNotBaseOriginal() {
      return this.product.slug !== 'base-original';
    },
    isNotPlain() {
      return this.product.slug !== 'base-atype-plain';
    },
    colorNums() {
